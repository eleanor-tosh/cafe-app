  ...
  return (
    <div className="container mx-auto py-20"> 
        ...
        <div className="py-40 pb-10 md:px-20" id="contact-section">
          <h1 className="font-bold text-bean text-center font-serif text-3xl leading-relaxed">Contact</h1>
        </div>
        ...
        <div className='md:grid grid-cols-2'>
          ...
          <div>
            ...
            <form className='md:px-24'>
              <div>
                <label className='font-bold text-bean font-serif text-xl p-10 leading-relaxed '>Name:
                <input id='name' type='name' placeholder='name' className='border rounded p-2 m-5 md:w-full'></input></label>
              </div>

              <div>
                <label className='font-bold text-bean font-serif text-xl p-10 leading-relaxed'>Email:
                <input id='email' type='email' placeholder='email' className='border rounded p-2 m-5 md:w-full'></input></label>
              </div>

              <div>
                <label className='font-bold text-bean font-serif text-xl p-10 leading-relaxed'>Phone:
                <input id='phone' type='phone' placeholder='phone' className='border rounded p-2 m-5 md:w-full'></input></label>
              </div>

              <div>
                <label className='font-bold text-bean font-serif text-xl p-10 leading-relaxed'>Subject:
                <input id='subject' type='text' placeholder='subject' className='border rounded p-2 m-5 md:w-full'></input></label>
              </div>

              <div>
                <label className='font-bold text-bean font-serif text-xl p-10 leading-relaxed'>Message:
                <textarea id='message' placeholder='message' className='border rounded p-2 m-5 md:w-full'/></label>
              </div>
