...
function Location() {
  return (
    <div className="container mx-auto py-20"> 
        <div className="py-40 md:px-20" id="location-section">
          <h1 className="font-bold text-bean text-center font-serif text-3xl leading-relaxed">Location</h1>
            <p className="font-medium text-text-grey font-serif text-xl p-10 leading-relaxed">Conveniently located near of of Dunedins amazing beaches. Bring the entire family (dog included) for an afternoon out.
            </p>
